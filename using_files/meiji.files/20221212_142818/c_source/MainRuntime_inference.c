...
typedef struct {
    void *buffer_pool[2];
    void *param_pool[6];
    rt_buffer_allocate_type_t variable_buffers_allocate_type[13];
    ...
    int v4_shape[1];
    rt_variable_t v5; ///< Affine_2/affine/W
    int v5_shape[2];
    rt_variable_t v6; ///< Affine_2/affine/b
    int v6_shape[1];
    rt_variable_t v7; ///< Convolution
    int v7_shape[4];
    rt_variable_t v8; ///< MaxPooling
    int v8_shape[4];
    rt_variable_t v9; ///< Convolution_2
    int v9_shape[4];
    rt_variable_t v10; ///< MaxPooling_2
    int v10_shape[4];
    rt_variable_t v11; ///< Affine_2
    int v11_shape[2];
    rt_variable_t v12; ///< Softmax_2
    int v12_shape[2];
    ...
    rt_function_t f5; ///< Softmax
    rt_variable_t* f5_inputs[1];
    rt_variable_t* f5_outputs[1];
    softmax_local_context_t *f5_local_context;
...
void* nnablart_mainruntime_allocate_context(void** params)
{
    ...
    if(params) {
        ...
        c->param_pool[0] = *params++;
        c->param_pool[0] = malloc(sizeof(float) * 90);
        ...
        c->param_pool[2] = *params++;
        c->param_pool[2] = malloc(sizeof(float) * 900);
        ...
        c->param_pool[4] = *params++;
        c->param_pool[4] = malloc(sizeof(float) * 3920);
    ...
    arg_f1_kernel.data[0] = 2;
    arg_f1_kernel.data[1] = 2;
    ...
    arg_f3_kernel.data[0] = 2;
    arg_f3_kernel.data[1] = 2;
    ...
    arg_f3_stride.data[0] = 2;
    arg_f3_stride.data[1] = 2;
    ...
    // Softmax
    c->f5_local_context = malloc(sizeof(softmax_local_context_t));
    ...
    (c->f5_local_context)->axis = 1;
    allocate_softmax_local_context(&(c->f5));
    return (void*)c;
}
...
int nnablart_mainruntime_free_context(void* context)
{
    ...
    free_softmax_local_context(&(c->f5));
